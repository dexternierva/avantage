...
function Testimonials () {
    return (
        <TestimonialsSection>
            <SectionHeader>
                <SectionHeader.PreTitle>Read What <b>People Are Saying</b> About Us</SectionHeader.PreTitle>
                <SectionHeader.Title>Our Client <b>Testimonials</b></SectionHeader.Title>
            </SectionHeader>
